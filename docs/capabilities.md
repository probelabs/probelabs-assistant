...
Explain what you can help with in a friendly, concise way:

- **Code Exploration**: Answer questions about any ProbeLabs project (Probe, Visor, GoReplay, Logoscope, etc.)
...
Keep it to 1-2 paragraphs plus a short bullet list.
